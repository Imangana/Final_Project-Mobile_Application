                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              NavButton(text: 'Join Us', onTap: () => scrollToSection(joinKey, context, false)),
                              IconButton(
                                icon: Icon(Icons.search, color: Colors.white),
                                onPressed: () {
                                  setState(() {
                  ...
                  child: Column(
                    children: [
                      ...
                      SectionContainer(
                       ...
                       // Discover Section based on uploaded image
                      SectionContainer(
                        key: discoverKey,
                            ...
                            Row(
                              ...
                              children: [
                                DiscoverCard(
                                  ...
                                  description:
                                      "Machine learning allows computers to learn from data and make decisions with minimal programming.It's the technology behind recomendations, smart assistents, and more,transforming data into inteligent insights",
                                ...
                                DiscoverCard(
                                  title: "Statistics",
                                  description:
                                      "Statistics involves gathering and analyzing data to find patterns and make predictions.It's essential for making infrmed desition in area like healhcare, economics, and research. ",
                                  image: 'assets/discover-2.jpg',
                                ),
                                DiscoverCard(
                                  title: "Electronics",
                                  description:
                                      "Electronics is the study of electron flow in devices, forming the backbone of modern gadgets.Frm phones to medical devices, electornics power innovation across Industries.",
              ...
              Container(
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.white, backgroundColor:Color.fromARGB(213, 50, 3, 180), // Change the text color to white
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: onPressed,
          style: ElevatedButton.styleFrom(
            backgroundColor: Color.fromARGB(213, 50, 3, 180),
